...
const AddressForm = () => {
    ...
    const customIcon = new L.Icon({
        iconUrl: "https://leafletjs.com/examples/custom-icons/leaf-green.png", // Simple green marker
        iconSize: [38, 95], // Adjust size
        iconAnchor: [22, 94], // Bottom-center anchor
        popupAnchor: [-3, -76], // Popup appears above
    });
